...
namespace AnonymousBlog.Infra.Migrations
{
    ...
    [Migration("20240516033922_Inital")]
            ...
            modelBuilder.Entity("PostPostTag", b =>
                {
                    ...
                    b.Property<int>("PostTagsPostId")
                        .HasColumnType("integer");

                    b.Property<int>("PostTagsTagId")
                        .HasColumnType("integer");

                    b.HasKey("PostId", "PostTagsPostId", "PostTagsTagId");

                    b.HasIndex("PostTagsPostId", "PostTagsTagId");
            ...
            modelBuilder.Entity("PostTagTag", b =>
                {
                    ...
                    b.HasKey("TagId", "PostTagsPostId", "PostTagsTagId");
            ...
            modelBuilder.Entity("PostPostTag", b =>
                {
                    ...
                    b.HasOne("AnonymousBlog.Core.Entities.PostTag", null)
                        .WithMany()
                        .HasForeignKey("PostTagsPostId", "PostTagsTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
